          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <GlassCard tone="aurora">
              <div className="space-y-3">
                ...
                <p className="text-white/70 text-sm">Emerald and teal gradients with a fresh, natural feel</p>
              </div>
            </GlassCard>
            ...
            <GlassCard tone="ember">
              <div className="space-y-3">
                ...
                <p className="text-white/70 text-sm">Warm amber and rose tones perfect for call-to-actions</p>
              </div>
            </GlassCard>
            ...
            <GlassCard>
              <div className="space-y-3">
                ...
                <p className="text-white/70 text-sm">Follows the active theme selection automatically</p>
              </div>
            </GlassCard>
            ...
            <GlassCard tone="midnight">
              <div className="space-y-3">
                ...
                <p className="text-white/70 text-sm">Deep purple hues for sophisticated, premium interfaces</p>
              </div>
            </GlassCard>
            ...
            <GlassCard tone="cosmic">
              <div className="space-y-3">
                ...
                <p className="text-white/70 text-sm">Vibrant pink to indigo creating magical experiences</p>
              </div>
            </GlassCard>
            ...
            <GlassCard intensity="strong">
              <div className="space-y-3">
                ...
                <p className="text-white/70 text-sm">Enhanced backdrop blur for maximum glassmorphism effect</p>
              </div>
            </GlassCard>
          </div>
        </div>
        ...
        <GlassCard intensity="strong" className="max-w-md mx-auto">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button className="w-full h-12 rounded-2xl bg-linear-to-r from-[rgb(var(--nc-accent-1))] via-[rgb(var(--nc-accent-2))] to-[rgb(var(--nc-accent-3))] text-white font-semibold hover:scale-[1.01] transition-all shadow-[0_12px_30px_rgb(var(--nc-accent-1)/0.45)] hover:shadow-[0_16px_36px_rgb(var(--nc-accent-1)/0.6)]">
                Sign In
              </button>
            </div>
          </div>
